...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        modelShader.setFloat("spotLight.cutOff", glm::cos(glm::radians(5.0f)));
        modelShader.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(7.0f)));
...
// Helper to load textures using stbi_load.
